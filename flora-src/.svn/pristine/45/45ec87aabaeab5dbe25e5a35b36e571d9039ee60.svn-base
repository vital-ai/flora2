...
#                        or of an alternative runflora script.
#                        This script must be in the Flora-2 installation folder.
...
if test $# -gt 1; then
    ...
    echo "       path      -- full path name of the Flora-2 installation folder"
    echo "                    or of an alternative runflora script. The script"
    echo "                    must be in the Flora-2 installation folder."
    exit
fi
...
if test -n "$windows"; then
    ...
    if test -z "$runflora_script"; then
	# if runflora_script is not set, set it
