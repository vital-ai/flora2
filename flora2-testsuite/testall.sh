...
default_testlist="general_tests apptests exporttest json defeasible/new_gclp defeasible/old_gclp defeasible/atck1 defeasible/atck1alt defeasible/atck2 defeasible/atck2alt defeasible/atco defeasible/atco2 defeasible/atco3 defeasible/refute_clp functions symbols delaystests"
